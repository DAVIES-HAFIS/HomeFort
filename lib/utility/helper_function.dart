...
class BVNTextField extends StatefulWidget {
  BVNTextField({
    this.bvnNumberTEC,
    this.obscure,
  });

  final TextEditingController bvnNumberTEC;
  final bool obscure;

  @override
  _BVNTextFieldState createState() => _BVNTextFieldState();
}

class _BVNTextFieldState extends State<BVNTextField> {
  @override
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      controller: this.widget.bvnNumberTEC,
      ...
      validator: (value) {
        ...
        return 'BVN should be 11 characters';
      },
      maxLength: 11,
...
class OtpTextField extends StatefulWidget {
  ...
  final TextEditingController otpcodeTEC;
  final bool obscure;
